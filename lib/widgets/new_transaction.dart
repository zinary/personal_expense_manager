...
class _NewTransactionState extends State<NewTransaction> {
  ...
  void submitValue() {
    ...
    if (enteredtitle.isEmpty ||  double.parse(enteredAmount) <= 0 || selectedDate == null) {
      return;
    }
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                Expanded(child: Text(selectedDate==null ? 'No date selected!' :'Picked Date: ' + DateFormat.yMMMEd().format(selectedDate )  )),
                FlatButton(
